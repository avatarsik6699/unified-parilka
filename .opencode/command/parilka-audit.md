---
description: Полный Qwen-heavy аудит и улучшение parilka-unified с независимыми review gates
agent: orchestrator
---
...
Провести полный ревью `parilka-unified`, улучшить репозиторий там, где вывод подтвержден кодом, тестами или внешним исследованием, затем независимо перепроверить результат.
